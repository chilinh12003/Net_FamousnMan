...
namespace MyWeb.Page
{
    ...
    /// </summary>
    public class Accept : MyASHXBase
    {
        public override void WriteHTML()
        {
            ...
            try
            {
                ...
                string Result = mClient.Reg((int)MyConfig.ChannelType.WEB, Signature, "DK");
                ...
                {
                    case "1":
                        ErrorDesc = "Chúc mừng bạn đã đăng ký thành công dịch vụ Nhận diện người nổi tiếng.";
                        break;
                    case "0":
