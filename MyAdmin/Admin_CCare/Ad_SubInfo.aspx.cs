...
namespace MyAdmin.Admin_CCare
{
    public partial class Ad_SubInfo : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Admin_Paging_VNP4.rpt_Data = rpt_BuyContent;
            Admin_Paging_VNP4.GetData_Callback_Change += new Admin_Control.Admin_Paging_VNP.GetData_Callback(Admin_Paging_VNP4_GetTotalPage_Callback_Change);
            Admin_Paging_VNP4.GetTotalPage_Callback_Change += new Admin_Control.Admin_Paging_VNP.GetTotalPage_Callback(Admin_Paging_VNP4_GetData_Callback_Change);
        ...
        DataTable Admin_Paging_VNP2_GetTotalPage_Callback_Change()
        {
            try
            {
                ...
                DataTable mTable = mChargeLog.Search_SelectType(SearchType, Admin_Paging_VNP2.mPaging.BeginRow, Admin_Paging_VNP2.mPaging.EndRow, SearchContent, PID, 0, 0, 0, BeginDate, EndDate, 2, SortBy);
        ...
        int Admin_Paging_VNP4_GetData_Callback_Change()
        {
            try
            {
                int SearchType = 0;
                ...
                return mChargeLog.TotalRow_SelectType(SearchType, SearchContent, PID, 0, 0, 0, BeginDate, EndDate, 3);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        DataTable Admin_Paging_VNP4_GetTotalPage_Callback_Change()
        {
            try
            {
                string SortBy = "LogID DESC";
                ...
                PageIndex_2 = (Admin_Paging_VNP4.mPaging.CurrentPageIndex - 1) * Admin_Paging_VNP4.mPaging.PageSize + 1;

                DataTable mTable = mChargeLog.Search_SelectType(SearchType, Admin_Paging_VNP4.mPaging.BeginRow, Admin_Paging_VNP4.mPaging.EndRow, SearchContent, PID, 0, 0, 0, BeginDate, EndDate, 3, SortBy);
