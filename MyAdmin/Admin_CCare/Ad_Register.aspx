                            ...
                            <asp:Repeater runat="server" ID="rpt_Data_Reg">
                                <ItemTemplate>
                                    <tr class="Table_Row_1">
                                        ...
                                        <td>
                                            <asp:Button runat="server" ID="tbx_Dereg" Text="Hủy"  OnClick="tbx_Dereg_Click" OnClientClick='<%# "return ConfirmDereg(\"" + Eval("MSISDN") + "\",\"Nhận diện người nổi tiếng\");"%>'/>
                                        </td>
                                        <td class="Table_MR_1">
                                        </td>
                                    </tr>
                                ...
                                <ItemTemplate>
                                    <tr class="Table_Row_1">
                                        ...
                                        <td>
                                            ...
                                            <asp:Button runat="server" ID="tbx_Reg" Text="Đăng ký" OnClick="tbx_Reg_Click" OnClientClick='<%# "return ConfirmReg(\""+Eval("MSISDN")+"\",\"Nhận diện người nổi tiếng\");"%>'/>
                                        </td>
                                        <td class="Table_MR_1">
                                        </td>
                                    </tr>
