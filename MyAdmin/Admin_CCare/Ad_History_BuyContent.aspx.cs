    ...
    public partial class Ad_History_BuyContent : System.Web.UI.Page
    {
        ...
        DataTable Admin_Paging1_GetData_Callback_Change()
        {
            try
            {
                ...
                DataTable mTable = mChargeLog.Search_SelectType(SearchType, Admin_Paging1.mPaging.BeginRow, Admin_Paging1.mPaging.EndRow, SearchContent, PID, 0, 0, 0, BeginDate, EndDate, 3, SortBy);
