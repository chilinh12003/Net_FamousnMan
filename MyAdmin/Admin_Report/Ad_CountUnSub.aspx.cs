    ...
    public partial class Ad_CountUnSub : System.Web.UI.Page
    {
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    mGetRole = new GetRole(MySetting.AdminSetting.ListPage.ReportCountUnSub, Member.MemberGroupID());
                }
                else
                {
        ...
        int Admin_Paging1_GetTotalPage_Callback_Change()
        {
            try
            {
                ...
                return mUnSub.Total_Count(SearchType);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        DataTable Admin_Paging1_GetData_Callback_Change()
        {
            try
            {
                ...
                return mUnSub.Search_Count(SearchType, SortBy);
            }
            catch (Exception ex)
            {
                throw ex;
