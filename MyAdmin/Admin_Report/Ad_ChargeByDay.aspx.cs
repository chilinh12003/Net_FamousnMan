    ...
    public partial class Ad_ChargeByDay : System.Web.UI.Page
    {
        ...
        int Admin_Paging1_GetTotalPage_Callback_Change()
        {
            try
            {
                ...
                return mChargeLog.TotalRow_ByDay(SearchType, 0, 0, BeginDate, EndDate);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        DataTable Admin_Paging1_GetData_Callback_Change()
        {
            try
            {
                ...
                return mChargeLog.Search_ByDay(SearchType, Admin_Paging1.mPaging.BeginRow, Admin_Paging1.mPaging.EndRow,  0, 0, BeginDate, EndDate, SortBy);
            }
            catch (Exception ex)
            {
                throw ex;
