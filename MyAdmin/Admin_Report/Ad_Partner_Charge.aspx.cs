...
{
    public partial class Ad_Partner_Charge : System.Web.UI.Page
    {
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    mGetRole = new GetRole(MySetting.AdminSetting.ListPage.RPPartnerDay, Member.MemberGroupID());
                }
                else
                {
        ...
        int Admin_Paging1_GetTotalPage_Callback_Change()
        {
            try
            {
                ...
                return mChargeLog.TotalRow_ByDay_Partner(SearchType, 0, 0, Member.PartnerID(), BeginDate, EndDate);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        DataTable Admin_Paging1_GetData_Callback_Change()
        {
            try
            {
                ...
                return mChargeLog.Search_ByDay_Partner(SearchType, Admin_Paging1.mPaging.BeginRow, Admin_Paging1.mPaging.EndRow, 0, 0,Member.PartnerID(), BeginDate, EndDate, SortBy);
            }
            catch (Exception ex)
            {
                throw ex;
