...
{
    public partial class Ad_Partner_Charge_ByPrice : System.Web.UI.Page
    {
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    mGetRole = new GetRole(MySetting.AdminSetting.ListPage.RPPartnerPrice, Member.MemberGroupID());
                }
                else
                {
        ...
        int Admin_Paging1_GetTotalPage_Callback_Change()
        {
            try
            {
                ...
                return mChargeLog.TotalRow_ByDay_Price_Partner(SearchType,Member.PartnerID(), BeginDate, EndDate);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        DataTable Admin_Paging1_GetData_Callback_Change()
        {
            try
            {
                ...
                return mChargeLog.Search_ByDay_Price_Partner(SearchType, Member.PartnerID(), Admin_Paging1.mPaging.BeginRow, Admin_Paging1.mPaging.EndRow, BeginDate, EndDate, SortBy);
            }
            catch (Exception ex)
            {
                throw ex;
