        ...
        <tbody>
           ...
           <tr style="background-color: #DADADA; font-weight:bold;">
            ...
            <tr style="background-color:#ffffff;">
                ...
                <%# this.GetValue((DateTime)Eval("ReportDay"),MyFamousMan.Report.RP_MO.MOType.Register)%>
             ...
             <tr style="background-color:#ffffff;">
               <%# this.GetValue((DateTime)Eval("ReportDay"),MyFamousMan.Report.RP_MO.MOType.Deregister)%>
            </tr>
            <tr style="background-color:#ffffff;">
               <%# this.GetValue((DateTime)Eval("ReportDay"),MyFamousMan.Report.RP_MO.MOType.BuyContent)%>
            </tr>
            <tr style="background-color:#ffffff;">
               <%# this.GetValue((DateTime)Eval("ReportDay"),MyFamousMan.Report.RP_MO.MOType.Answer)%>
            </tr>
            <tr style="background-color:#ffffff;">
               <%# this.GetValue((DateTime)Eval("ReportDay"),MyFamousMan.Report.RP_MO.MOType.Other)%>
            </tr>
            <tr style="background-color:#ffffff;">
               <%# this.GetValue((DateTime)Eval("ReportDay"),MyFamousMan.Report.RP_MO.MOType.Invalid)%>
            </tr>
             </ItemTemplate>
