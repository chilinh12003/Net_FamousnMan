...
{
    public partial class Ad_Question : System.Web.UI.Page
    {
        ...
        int Admin_Paging1_GetTotalPage_Callback_Change()
        {
            try
            {
                ...
                return mQuestion.TotalRow(SearchType, str_SearchContent, (Question.Status)StatusID);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        DataTable Admin_Paging1_GetData_Callback_Change()
        {
            try
            {
                ...
                return mQuestion.Search(SearchType, Admin_Paging1.mPaging.BeginRow, Admin_Paging1.mPaging.EndRow, str_SearchContent, (Question.Status)StatusID,  SortBy);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        protected void lbtn_Delete_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (mQuestion.Delete(0, dds_Parent.GetXml()))
                {
                    #region Log member
                    MemberLog mLog = new MemberLog();
                    MemberLog.ActionType Action = MemberLog.ActionType.Delete;
                    mLog.Insert("Question", string.Empty, dds_Parent.GetXml(), Action, true, string.Empty);
                    #endregion
