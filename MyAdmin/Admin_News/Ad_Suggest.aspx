<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Admin.Master" AutoEventWireup="true" CodeBehind="Ad_Suggest.aspx.cs" Inherits="MyAdmin.Admin_News.Ad_Suggest" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cph_Tools" runat="server">
    ...
    <a href='Ad_Question.aspx?QID=<%=this.QuestionID %>'><span class="Cancel"></span>Hủy </a>
    ...
    <table class="Data" border="0" cellpadding="0" cellspacing="0">
        <tbody>
            <tr class="Table_Header">
                ...
                <th>
                    <asp:LinkButton runat="server" CssClass="Sort" ID="lbtn_Sort_1" CommandArgument="SuggestID ASC" OnClick="lbtn_Sort_Click">Mã</asp:LinkButton>
                </th>
                <th style="width: 30%;">
                    Nội dung
                </th>
                ...
                <th>
                    <asp:LinkButton runat="server" CssClass="Sort" ID="lbtn_Sort_3" CommandArgument="OrderNumber ASC" OnClick="lbtn_Sort_Click">Thứ tự</asp:LinkButton>
                </th>
                <th>
                    Tình trạng
                </th>
                ...
                <ItemTemplate>
                    <tr class="Table_Row_1">
                        ...
                        <td align="center" width="10">
                            <%#"<input type='checkbox' id='CheckAll_" + Container.ItemIndex.ToString() + "' value='" + Eval("SuggestID").ToString() + "' />"%>
                        </td>
...
<asp:Content ID="Content6" ContentPlaceHolderID="cph_Javascript" runat="server">
    <script language="javascript" type="text/javascript">
        ...
        function EditData() {
            if (BeforeEditData()) {
                document.location = '../Admin_News/Ad_Suggest_Edit.aspx?QID=<%=this.QuestionID %>&ID=' + hid_ListCheckAll.value;
