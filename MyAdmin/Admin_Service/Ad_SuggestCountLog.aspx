<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Admin.Master" AutoEventWireup="true" CodeBehind="Ad_SuggestCountLog.aspx.cs" Inherits="MyAdmin.Admin_Service.Ad_SuggestCountLog" %>
    ...
    <table class="Data" border="0" cellpadding="0" cellspacing="0">
        <tbody>
            <tr class="Table_Header">
                ...
                <th>
                    <asp:LinkButton runat="server" CssClass="Sort" ID="lbtn_Sort_1" CommandArgument="QuestionID ASC" OnClick="lbtn_Sort_Click">Câu hỏi</asp:LinkButton>
                </th>
                <th>
                    <asp:LinkButton runat="server" CssClass="Sort" ID="lbtn_Sort_8" CommandArgument="OrderNumber ASC" OnClick="lbtn_Sort_Click">Thứ tự dữ kiện</asp:LinkButton>
                </th>
                <th>
                ...
                <th>
                    <asp:LinkButton runat="server" CssClass="Sort" ID="lbtn_Sort_3" CommandArgument="IncorrectCount ASC" OnClick="lbtn_Sort_Click">SL Dự đoán sai</asp:LinkButton>
                </th>
                <th>
                    <asp:LinkButton runat="server" CssClass="Sort" ID="lbtn_Sort_7" CommandArgument="LastUpdate DESC" OnClick="lbtn_Sort_Click">Ngày cập nhật</asp:LinkButton>
                </th>
            ...
            <asp:Repeater runat="server" ID="rpt_Data">
                <ItemTemplate>
                    <tr class="Table_Row_1">
                        ...
                        <td>
                            <%#Eval("PlayDate") == DBNull.Value ? string.Empty : ((DateTime)Eval("PlayDate")).ToString(MyUtility.MyConfig.ShortDateFormat)%>
                        </td>
                        <td>
                            <%#Eval("SuggestID")%>
                        </td>
